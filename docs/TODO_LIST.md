...
### 3.1 사용자 관리
- [x] **ADMIN-001**: 전체 구직자 조회 `/admin/users` (폴더 미존재)
- [x] **ADMIN-002**: 계정 정지/제재 관리
- [x] **ADMIN-003**: 신고 관리 `/admin/reports` (폴더 미존재)

### 3.2 기업 및 콘텐츠 관리
- [x] **ADMIN-007**: 등록 기업 목록 조회 (승인된 기업 관리) `/admin/companies` (폴더 미존재, `approvals`만 존재)
- [x] **ADMIN-008**: 불법 공고 관리
- [x] **ADMIN-015**: 공지 및 이벤트 관리

### 3.3 서비스 관리
- [x] **ADMIN-013**: 결제 관리 (환불 처리)
- [x] **ADMIN-014**: 구독 플랜 관리
