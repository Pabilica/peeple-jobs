...
### 2.2 채용 공고 관리
- [ ] **COMP-006**: 공고 등록/발행 `/company/postings` (폴더 미존재)
- [ ] **COMP-007**: 다국어 공고 작성 편집기
- [ ] **COMP-011**: 지원자 상세 관리 (합불/검토) `/company/applicants` (폴더 미존재)
- [ ] **COMP-012**: 면접 일정 조정

### 2.3 대시보드 및 서비스
- [ ] **COMP-017**: 채용공고 이미지 첨부
- [ ] **COMP-020**: 채팅 (기업-구직자)
- [ ] **COMP-023**: 마이페이지 (결제/알림) `/company/settings` (폴더 미존재)
