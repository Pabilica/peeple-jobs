                    ...
                    <div className="flex-1 overflow-y-auto overflow-x-hidden custom-scrollbar bg-background-light dark:bg-background-dark p-6 lg:p-10 pb-20">
                        <div className="max-w-[1280px] mx-auto space-y-8">
                            ...
                            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                                <div>
                                    <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 dark:text-white tracking-tight">{t('greeting', { name: 'TechCorp' })}</h2>
                                    <p className="text-slate-500 dark:text-slate-400 mt-2 text-base">{t('subtitle')}</p>
                                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6">
                                ...
                                <div className="bg-surface-light dark:bg-[#1e1e1e] p-6 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-soft group hover:border-primary/30 transition-colors">
                                    <div className="flex justify-between items-start mb-4">
                                        ...
                                        <span className="text-xs font-bold text-slate-400 bg-slate-50 dark:bg-slate-800 px-2 py-1 rounded-md">{t('live')}</span>
                                    </div>
                                    <p className="text-sm font-medium text-slate-500 dark:text-slate-400">{t('activePostings')}</p>
                                ...
                                <div className="bg-surface-light dark:bg-[#1e1e1e] p-6 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-soft group hover:border-primary/30 transition-colors relative overflow-hidden">
                                    ...
                                    <div className="flex justify-between items-start mb-4 relative z-10">
                                        ...
                                        <span className="text-xs font-bold text-primary bg-primary/10 px-2 py-1 rounded-md">{t('trending')}</span>
                                    </div>
                                    <p className="text-sm font-medium text-slate-500 dark:text-slate-400 relative z-10">{t('newApplicants')}</p>
                                ...
                                <div className="bg-surface-light dark:bg-[#1e1e1e] p-6 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-soft group hover:border-primary/30 transition-colors">
                                    <div className="flex justify-between items-start mb-4">
                                        ...
                                        <span className="text-xs font-bold text-slate-400 bg-slate-50 dark:bg-slate-800 px-2 py-1 rounded-md">{t('thisWeek')}</span>
                                    </div>
                                    <p className="text-sm font-medium text-slate-500 dark:text-slate-400">{t('interviewing')}</p>
                                    <div className="flex items-end gap-3 mt-1">
                            ...
                            <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                                ...
                                <div className="xl:col-span-2 bg-surface-light dark:bg-[#1e1e1e] rounded-2xl border border-slate-100 dark:border-slate-800 shadow-soft flex flex-col">
                                    <div className="p-6 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
                                        <h3 className="font-bold text-lg text-slate-900 dark:text-white">{t('recentApplicants')}</h3>
                                        ...
                                        <table className="w-full text-left border-collapse">
                                            <thead>
                                                <tr className="text-xs font-bold text-slate-400 border-b border-dashed border-slate-200 dark:border-slate-800">
                                                    ...
                                                    <th className="px-4 py-3">{t('visaStatus')}</th>
                                                    <th className="px-4 py-3">{t('appliedFor')}</th>
                                ...
                                <div className="space-y-6 flex flex-col">
                                    ...
                                    <div className="bg-surface-light dark:bg-[#1e1e1e] p-6 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-soft flex-1">
                                        <h3 className="font-bold text-lg text-slate-900 dark:text-white mb-1">{t('visaDistribution')}</h3>
                                        <p className="text-xs text-slate-500 mb-6">{t('basedOnActiveApplicants')}</p>
                                    ...
                                    <div className="bg-surface-light dark:bg-[#1e1e1e] p-6 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-soft">
                                        <div className="flex items-center justify-between mb-4">
                                            <h3 className="font-bold text-lg text-slate-900 dark:text-white">{t('interviews')}</h3>
                                            <span className="text-xs font-bold text-primary bg-primary/10 px-2 py-1 rounded-md">{t('today')}</span>
                                        </div>
                                        <div className="space-y-4">
